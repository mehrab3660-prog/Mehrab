  ...
  return (
    <div>
      ...
      <AdminHelp storageKey="ai-products">
        ...
        <p>عکس محصول از این طریق ساخته نمی‌شود — بعد از تأیید، از صفحه‌ی «محصولات» عکس را مثل همیشه آپلود کنید.</p>
        <p>اگر کلید API هوش مصنوعی در «تنظیمات» وارد نشده باشد، این قابلیت کار نمی‌کند.</p>
      </AdminHelp>
